...
public class TimesController {
	...
	@RequestMapping(path="/{idTime}/removerjogador",method = RequestMethod.POST)
	public String removerJogadorDoTime(@PathVariable("idTime") Integer idTime, @RequestParam Integer idJogador){
